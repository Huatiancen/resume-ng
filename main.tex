...
\ResumeContacts{
  ...
  \ResumeUrl{https://huatiancen.github.io}{https://huatiancen.github.io},%
  \ResumeUrl{https://github.com/Huatiancen}{https://github.com/Huatiancen}%
}
...
[南京大学|本科生]
{南京大学}
[\textnormal{软件工程，软件学院|}  本科生]
[2023.09—2027.06（预计）]

\textbf{GPA: 4.48/5.0} \textbf{2027年应届生}。

主要研究成果为：发表在 XXX 期刊上的论文《XXX》。

\section[技术能力]{技术能力}
\begin{itemize}
  \item \textbf{语言}: 编程不受特定语言限制。常用 Java, Python, C++； 熟悉 Java, \GrayText{JavaScript}；了解 Lua, Java, \GrayText{TypeScript}。
...
\ResumeItem{\textbf{Tomatomall} 番茄书城}
\begin{itemize}
